package com.bootdo.common.redis.common;
...
public class RedisCacheUtil<T> {
    ...
    public void setRedisTemplate(RedisTemplate<String, Object> redisTemplate) {
        if (null == redisTemplate) {
            logger.info("Redis初始化配置失败，请检查配置项");
        } else {
            logger.info("Redis初始化配置注入成功！");
        }
    ...
    public static boolean expire(String key, long time) {
        try {
            ...
            logger.error("expire() is error : {}", e);
            return false;
        }
    }
    ...
    public static boolean hasKey(String key) {
        try {
            ...
            logger.error("hasKey() is error : {}", e);
            return false;
        }
    }
    ...
    public static boolean sHasKey(String key, Object value) {
        try {
            ...
            logger.error("sHasKey() is error : {}", e);
            return false;
        }
    }
    ...
    public static long sSetAndTime(String key, long time, Object... values) {
        try {
            ...
            logger.error("sSetAndTime() is error : {}", e);
            return 0;
        }
    }
    ...
    public static long sGetSetSize(String key) {
        try {
            ...
            logger.error("sGetSetSize() is error : {}", e);
            return 0;
        }
    }
    ...
    public static long setRemove(String key, Object... values) {
        try {
            ...
            logger.error("setRemove() is error : {}", e);
            return 0;
        }
    }
    ...
    public static long lGetListSize(String key) {
        try {
            ...
            logger.error("lGetListSize() is error : {}", e);
            return 0;
        }
    }
    ...
    public static Object lGetIndex(String key, long index) {
        try {
            ...
            logger.error("lGetIndex() is error : {}", e);
            return null;
        }
    }
    ...
    public static boolean lUpdateIndex(String key, long index, Object value) {
        try {
            ...
            logger.error("lUpdateIndex() is error : {}", e);
            return false;
        }
    }
    ...
    public static long lRemove(String key, long count, Object value) {
        try {
            ...
            logger.error("lRemove() is error : {}", e);
            return 0;
        }
    }
